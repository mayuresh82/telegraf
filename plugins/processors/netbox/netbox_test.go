...
var ipRaw = `{"count":1,"next":null,"previous":null,"results":[{"id":1531,"family":4,"address":"141.193.3.5/32","vrf":null,"tenant":null,"status":{"value":1,"label":"Active"},"role":null,"assigned_object":{"id":42419,"device":{"id":1019,"url":"https://netbox.roblox.local/api/dcim/devices/1019/","name":"br1-sjc1","display_name":"br1-sjc1"},"name":"lo0.0", "cable": null}]}`
